...
const ActivityRow1: NextPage<ActivityRow1Type> = ({
  className = "",
  propPadding,
  image,
  vrbsDAO,
    ...
    >
      ...
      >
          ...
          >
            <div
              className={css`
                ...
                align-items: flex-start;
                justify-content: flex-start;
                padding: 0rem var(--padding-144xl) 0rem 0rem;
                gap: var(--gap-5xs);
                @media screen and (max-width: 450px) {
        ...
        <div
          ...
          `}
        >
          Vrbs is a DAO that helps people in need, improves public spaces, and
          supports artists. With Vrbs, you can earn a vote for your efforts.
        </div>
      </div>
    </div>
  );
